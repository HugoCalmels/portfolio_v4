...
const Footer = () => {
  ...
  const pagesLeft = [
    ...
    { label: 'Création de sites', href: `/${locale}/creation-site-internet-toulouse` },
    { label: 'Développement web', href: `/${locale}/developpement-web-toulouse` },
  ]
  ...
  Création de sites internet et développement web.
</p>
          <a
